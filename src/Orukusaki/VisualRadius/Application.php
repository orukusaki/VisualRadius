...
use Orukusaki\VisualRadius\ServiceProvider\TwigGlobalProvider;
        ...
        $this->register(
            ...
            array(
                ...
                'doctrine.odm.mongodb.documents' => array(
                    array(
                        'type'      => 'annotation',
                        'path'      => '/src/Orukusaki/VisualRadius/Data',
    ...
    private function setupRoutes()
    {
        ...
        $app->get(
            ...
            function (Request $request, $imageId, $format) use ($app) {
                ...
                $preRenderedData = $app['doctrine.odm.mongodb.dm']->find(
                    __NAMESPACE__ . '\\Data\\PreRenderedData',
                    $imageId
                );
